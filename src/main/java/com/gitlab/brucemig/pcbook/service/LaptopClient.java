...
public class LaptopClient {
    ...
    public void createLaptop(Laptop laptop) {
        ...
        try {
            response = blockingStub.withDeadlineAfter(15, TimeUnit.SECONDS).createLaptop(request);
    ...
    public void rateLaptop(String[] laptopIDs, double[] scores) throws InterruptedException {
        ...
        StreamObserver<RateLaptopRequest> requestObserver = asyncStub.withDeadlineAfter(15, TimeUnit.SECONDS)
                .rateLaptop(new StreamObserver<RateLaptopResponse>() {
                    ...
                    @Override
                    public void onCompleted() {
                        logger.info("rate laptop comp leted");
                        finishLatch.countDown();
                    }
                });
    ...
    public static void testUploadImage(LaptopClient client, Generator generator) throws InterruptedException {
        Laptop laptop = generator.NewLaptop();
        client.createLaptop(laptop);
        client.uploadImage(laptop.getId(), "tmp/laptop.jpeg");
    }
